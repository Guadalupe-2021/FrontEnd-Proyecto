...
import { ModificarReclusoComponent } from './reclusos/modificar-recluso/modificar-recluso.component.js';
...
export const routes: Routes = [
    ...
    {path: 'menu/recluso/modificar-recluso', component:ModificarReclusoComponent },
